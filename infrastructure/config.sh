...
export project="xc3team12susan"
export domain="example.test.co"
export owner_email="104491527@student.swin.edu.au"
export creator_email="104491527@student.swin.edu.au"
export namespace="xc3team12susan"
export env="dev"